...
from rdl_backend.app.utils.security import create_access_token
...
@mock.patch("rdl_backend.app.api.auth.create_access_token",
...
@mock.patch("rdl_backend.app.api.auth.store_user",
