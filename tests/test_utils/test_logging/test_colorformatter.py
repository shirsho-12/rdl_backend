...
import click
import logging
from rdl_backend.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("rdl_backend.app.utils.logging.click.style",
    ...
    @mock.patch("rdl_backend.app.utils.logging.logging.Formatter")
